    ...
    <DashboardLayout isAdmin={true}>
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          <StatsCard title="Total Bookings" value={totalBookings} icon={ShoppingBag} />
          <StatsCard title="Pending Bookings" value={pendingBookings} icon={Activity} type="warning" />
          <StatsCard title="Completed Bookings" value={completedBookings} icon={CheckCircle} type="success" />
